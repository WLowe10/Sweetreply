...
After creating your project, you can now control what posts we pull in for you by making your keywords. To find leads for Ping Parrot, we will setup these keywords. We aren't using negative keywords for this example, but you can use them to exclude certain terms from being detected.
