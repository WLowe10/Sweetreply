...
Sweetreply, unlike many other platforms, goes further than positive and negative keywords. We support a more advanced lucene-like that allows:
...
This query will match any post that contains the words `service | company`, `lawn` and 'california', while still excluding any posts containing `repair`
