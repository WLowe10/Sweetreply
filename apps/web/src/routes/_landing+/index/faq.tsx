		...
		<Container size="md" py="xl" w="100%">
			...
			<Accordion>
				<Accordion.Item value="sites">
					...
					<Accordion.Panel>
						Currently we only support Reddit, however we are working on adding support
						for X and Hacker News. As Reddit is our first platform, we are focusing on
						making it the best.
					</Accordion.Panel>
				</Accordion.Item>
				<Accordion.Item value="results">
					<Accordion.Control>How long does Sweetreply take to setup?</Accordion.Control>
					<Accordion.Panel>
						Sweetreply is designed to be user-friendly and easy to set up. After
						creating a project and setup your query, leads will begin appearing within
						minutes.
					</Accordion.Panel>
				</Accordion.Item>
				<Accordion.Item value="free-plan">
					...
					<Accordion.Panel>
						...
						generate replies. However, you may use Sweetreply as a keyword monitoring
						tool free of charge.
					</Accordion.Panel>
				</Accordion.Item>
			</Accordion>
