...
export const replyPrompt = ({ project, lead, characterLimit }: ReplyPromptData) => {
	...
	return {
		...
		- You must positively mention the product in some capacity, feel free to include a personal anecdote.
		- You have used the product and therefore can give a worthy recommendation to it. You have no affiliations with the product.
